...
class _BundlePageState extends State<BundlePage> {
                  ...
                  return Column(
                    children: [
                      Row(
                        ...
                        children: indicators(bundles, activePage),
                      ),
                      SizedBox(
                                ...
                                Expanded(
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      Items item = snapshot.data![pageIndex]!
                                          .data!.items![index];
                                      return GestureDetector(
                                        onTap: () async {
                                          ...
                                          if (skin != null) {
                                            ...
                                            final state =
                                                Provider.of<Valstore>(context);

                                            final localSkin =
                                                state.localOffers.offers
                                                    ?.where(
                                                      (offer) =>
                                                          offer.offerID! ==
                                                          item.uuid!,
  ...
  List<Widget> indicators(List<BundleDisplayData?> bundles, currentIndex) {
    return List<Widget>.generate(
      ...
      (index) {
        return Container(
          ...
          child: Text(
            bundles[index]?.bundleData?.displayName ?? "",
            style: TextStyle(
              fontSize: currentIndex == index ? 20 : 10,
              fontWeight:
